...
# _concat = rnn.static_rnn._concat
# _like_rnncell = rnn.like_rnncell
...
def bidirectional_dynamic_rnn(cell_fw, cell_bw, inputs, sequence_length=None,
  ...
  # if not _like_rnncell('A_like_rnncell', cell_fw):
  #   raise TypeError("cell_fw must be an instance of RNNCell")
  # if not _like_rnncell('B_like_rnncell', cell_bw):
...
def dynamic_rnn(cell, inputs, att_scores=None, sequence_length=None, initial_state=None,
  ...
  """
  # if not _like_rnncell('C_like_rnncell', cell):
...
def raw_rnn(cell, loop_fn,
  ...
  **NOTE: This method is still in testing, and the API may change.**
  ...
  # if not _like_rnncell('D_like_rnncell', cell):
  #   raise TypeError("cell must be an instance of RNNCell")
...
def static_rnn(cell,
  ...
  # if not _like_rnncell('E_like_rnncell', cell):
  #   raise TypeError("cell must be an instance of RNNCell")
...
def static_bidirectional_rnn(cell_fw,
  ...
  # if not _like_rnncell('F_like_rnncell', cell_fw):
  #   raise TypeError("cell_fw must be an instance of RNNCell")
  # if not _like_rnncell('G_like_rnncell', cell_bw):
  #   raise TypeError("cell_bw must be an instance of RNNCell")
  if not nest.is_sequence(inputs):
    raise TypeError("inputs must be a sequence")
  if not inputs:
